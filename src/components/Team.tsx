  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 sm:top-6 left-3 sm:left-6 w-24 sm:w-32 md:w-40 h-1.5 sm:h-2 bg-[#0D0D0D]/20 rounded-full overflow-hidden">
        <div
          className="h-full bg-[#F2A516] transition-[width] duration-100 ease-linear"
          ...
          return (
            ...
            >
              ...
              <div className="mb-6 sm:mb-16 md:mb-16 mt-6 sm:mt-10 md:mt-1">
                ...
                <div className="h-1 sm:h-[2px] md:h-[3px] w-8 sm:w-12 md:w-16 bg-[#0D0D0D] mx-auto rounded-full mt-1.5 sm:mt-2" />
              </div>
              ...
              <div className="grid grid-cols-2 justify-items-center lg:flex lg:flex-wrap justify-center gap-4 sm:gap-6 md:gap-8 lg:gap-10 max-w-6xl mx-auto px-2 sm:px-4">
                {members.map((member, index) => (
                  <div
                    ...
                    style={{
                      animation: `teamFadeUp 0.6s cubic-bezier(0.16,1,0.3,1) ${index * 0.06}s forwards`,
                      opacity: 0,
                    }}
                  >
                    <div
                      className={`ck-card relative bg-[#f9f7e5]
                        ...
                        min-h-60 sm:min-h-72 md:min-h-80 flex-shrink-0`}
                    ...
                    >
                      ...
                      {/* Name */}
                      <h3 className="text-xs sm:text-sm md:text-base font-extrabold text-[#0D0D0D] group-hover:scale-105 transition-transform leading-tight text-center"
>
                        {member.name}
                      </h3>

                      {/* Role */}
                      <p className="text-[#F2A516] font-bold text-[10px] sm:text-xs md:text-sm uppercase mb-1.5 sm:mb-2 tracking-wide text-center leading-tight">
                        {member.role}
                      </p>
      ...
      <style jsx>{`
        ...
        /* Removed section::before to prevent global texture leak */
